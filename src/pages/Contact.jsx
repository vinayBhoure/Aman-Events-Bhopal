                                    ...
                                    <div className="space-y-6">
                                        <div className="flex items-start">
                                            ...
                                            <div className="ml-4">
                                                ...
                                                <p className="text-neutral-400 mt-1">Bhopal, Madhya Pradesh</p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex items-start">
                                            ...
                                            <div className="ml-4">
                                                ...
                                                <NavLink to="mailto:info@amaneventsbhopal.com" className="text-neutral-400 mt-1 hover:text-white transition-colors duration-300">info@amaneventsbhopal.com</NavLink>
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex items-start">
                                            ...
                                            <div className="ml-4">
                                                ...
                                                <NavLink to="tel:+919876543210" className="text-neutral-400 mt-1 hover:text-white transition-colors duration-300">+91 98765 43210</NavLink>
                                            </div>
                                        </div>
                                    </div>
                                </div>
