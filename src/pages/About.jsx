...
const About = () => {
  return (
    ...
    <div className="max-w-7xl mx-auto min-h-screen">
      {/* Header Section */}
      <div className="relative h-[60vh] text-center bg-gradient-to-r from-purple-900 to-indigo-800">
        <div className="absolute inset-0 bg-black/50"></div>
        <div className="relative container mx-auto px-4 h-full flex items-center">
          <div className="max-w-3xl mx-auto">
            <h1 className="text-5xl font-bold text-white mb-6">Crafting Unforgettable Moments</h1>
            <p className="text-xl text-gray-200">With over a decade of experience, we transform your vision into extraordinary events.</p>
          </div>
        </div>
      </div>
